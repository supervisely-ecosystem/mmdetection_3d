...
[![](https://img.shields.io/badge/supervisely-ecosystem-brightgreen)](https://ecosystem.supervisely.com/apps/supervisely-ecosystem/mmdetection_3d/serve)
[![](https://img.shields.io/badge/slack-chat-green.svg?logo=slack)](https://supervisely.com/slack)
![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/supervisely-ecosystem/mmdetection_3d)
[![views](https://app.supervisely.com/img/badges/views/supervisely-ecosystem/mmdetection_3d/serve.png)](https://supervisely.com)
[![runs](https://app.supervisely.com/img/badges/runs/supervisely-ecosystem/mmdetection_3d/serve.png)](https://supervisely.com)
...
Model and directory structure must be acquired via [Train MMDetection](https://app.supervisely.com/ecosystem/apps/mmdetection_3d/train) app or manually created with the same directory structure.
...
**Step 3.** Open [Serve MMDetection3D](https://app.supervisely.com/ecosystem/apps/mmdetection_3d/serve) app and open `Custom weights` tab. Paste checkpoint path to opened text field and press `Serve` button. Your model is ready to use!
